...
Hieronder is een opsomming van rekenhulpmiddelen:
	\begin{description}
		...
		Zelf hebben we nog gebruik gemaakt van tabellen om de kansen van normale of andere verdelingen op te zoeken.
		\item[Quipu] De Inca's stelden getallen voor en bewaarde ze met behulp van knoopjes in touwen.
		\item[Kerfstok] De inkervingen hierop stellen getallen voor.
